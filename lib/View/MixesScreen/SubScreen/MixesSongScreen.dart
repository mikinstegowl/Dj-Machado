            ...
            children: [
              Scaffold(
                ...
                body: GetBuilder<MixesController>(
                    init: Get.find<MixesController>(),
                    builder: (Controller) {
                      return Container(
                        height: MediaQuery.sizeOf(context).height,
                        padding: EdgeInsets.only(
                            top: AppBar().preferredSize.height.h + 25.h),
                        decoration: const BoxDecoration(
                            image: DecorationImage(
                                fit: BoxFit.cover,
                                image: AssetImage(AppAssets.backGroundImage))),
                        child: SingleChildScrollView(
                          controller: Get.find<MixesController>().scrollController1,
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Visibility(
                                visible: Get.find<MixesController>()
                              ...
                              Visibility(
                                ...
                                child: SizedBox(
                                  ...
                                  child: GridView.builder(
                                      ...
                                      itemCount: Get.find<MixesController>()
                                          .mixesTracksDataModel
                                          ?.mostPlayed
                                          ?.length,
