...
class SongDownloadWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return  Obx(()=>Get.find<BaseController>().databaseDownloadedSongList.isNotEmpty && Get.find<BaseController>().databaseDownloadedSongList.any((test)=> test['isDownloaded'] == 1)?  Column(
      children: [
        ListView.builder(
