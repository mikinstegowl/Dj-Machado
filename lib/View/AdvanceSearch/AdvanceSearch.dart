        ...
        body: Container(
          ...
          child: GetBuilder<AdvanceSearchController>(
              ...
              builder: (controller) {
                return
                Visibility(
                  visible: !Get.find<AdvanceSearchController>().isLoading.value,
                      ...
                      child: AppTextFormField(
                        ...
                        onChanged: (value) async {
                          if (value != '') {
                            ...
                            await controller.advanceSearchApi(0).then((_) {
                              controller.showLoader(false);
                            });
                            // };
                            // );
                          } else {
                            controller.advanceSearchSongDataModel.value = null;
                            controller.recentSearch();
                          }
                        },
                        hintText: "Search",
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            RecentSearchWidget(
                              ...
                              trendinglistData: controller
                                  .recentSearchDataModel?.trendinglistData,
                            ),
                          ],
                        ),
                      ),
